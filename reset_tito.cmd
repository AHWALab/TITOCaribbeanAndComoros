...
REM warmup snapshot (20251010 00:00). Matches:
REM   20251010_0000  20251010_000000  20251010.0000  20251010.000000  202510100000
...
echo   Keep   : states *.tif for 2025-10-10 01:00 ^(any common spelling^)
echo.
...
:is_keep
set "KEEP_HIT=0"
echo %~1| findstr /I /L /C:"20251010_0000" /C:"20251010_000000" /C:"20251010.0000" /C:"20251010.000000" /C:"202510100000" >nul
...
if !TOTAL! GTR 0 if !KEEPN! EQU 0 if not "%FORCE%"=="1" (
  echo ERROR: no state tif matched 2025-10-10 00:00 — refusing to delete any state tifs.
