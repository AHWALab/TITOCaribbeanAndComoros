...
REM warmup snapshot (20240426 23:00). Matches:
REM   20240426_2300  20240426_230000  20240426.2300  20240426.230000  202404252300
...
:is_keep
set "KEEP_HIT=0"
echo %~1| findstr /I /L /C:"20240426_2300" /C:"20240426_230000" /C:"20240426.2300" /C:"20240426.230000" /C:"202404252300" >nul
...
if !TOTAL! GTR 0 if !KEEPN! EQU 0 if not "%FORCE%"=="1" (
  echo ERROR: no state tif matched 2024-04-26 23:00 — refusing to delete any state tifs.
