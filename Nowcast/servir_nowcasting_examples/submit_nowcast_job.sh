...
#SBATCH --error=/vol_efthymios/NFS07/en279/SERVIR/TITO_test3/ML/examples/slurm_outputs/testjob.%J.err 

#SBATCH --output=/vol_efthymios/NFS07/en279/SERVIR/TITO_test3/ML/examples/slurm_outputs/testjob.%J.out
