...
# IMERG ops: SCaMPR fills T-4h → T, then StormLab as QPE.
# Operational extras STREAM-Sat+StormLab and IMERG+AROME are supported by the same code path.
...
# ── FIM ────────────────────────────────────────────────────────────────────
# After Phase C only. 30m Barbados (11 parish sites). Must run FIM at 30m.
fim_enabled = True
fim_config_dir = "fim_config"
fim_default_thresholds_m = [0.10, 0.30, 0.70, 1.00]
fim_regions = {
    "Barbados": {"enabled": True, "thresholds_m": fim_default_thresholds_m},
}
