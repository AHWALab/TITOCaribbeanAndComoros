# to download IMERG final run data from online
...
server = 'https://arthurhouhttps.pps.eosdis.nasa.gov/gpmallversions/V06'
file_prefix = '3B-HHR-GIS.MS.MRG.3IMERG.'
file_suffix = '.V06B.tif'
# Email associated to PMM account
email = 'vrobledodelgado@uiowa.edu'

#3B-HHR-GIS.MS.MRG.3IMERG.20180618-S000000-E002959.0000.V06B.tif
...
# And initial date then starts 3 months before that, to give data for EF5 warm up period
  ...
  while current_date < final_date:
    ...
    #local_storage = '/Users/vrobledodelgado/Library/CloudStorage/OneDrive-UniversityofIowa/PhD/SERVIR_PROJECT/WEST_AFRICA/GhanaSimulation/Observations/precip_imerg/'
