...
param_dict_of_dicts = {'naive':{'model_type': 'naive',
                                    'config_path': 'Nowcast/servir_nowcasting_examples/configs/wa_imerg/naive_persistence.py', 
                                    'model_save_path': None, 
                                    'input_h5_fname': 'Nowcast/servir_nowcasting_examples/temp/input_imerg.h5', 
                                    'output_h5_fname':'Nowcast/servir_nowcasting_examples/temp/output_naive_persistence.h5', 
                                    'use_gpu': False
                                    },
                           'lagrangian': {'model_type': 'lagrangian',
                                    'config_path': 'Nowcast/servir_nowcasting_examples/configs/wa_imerg/lagrangian_persistence.py', 
                                    'model_save_path': None, 
                                    'input_h5_fname': 'Nowcast/servir_nowcasting_examples/temp/input_imerg.h5', 
                                    'output_h5_fname':'Nowcast/servir_nowcasting_examples/temp/output_lagrangian_persistence.h5', 
                                    'use_gpu': False
                           },
                           'linda': {'model_type': 'linda',
                                    'config_path': 'Nowcast/servir_nowcasting_examples/configs/wa_imerg/LINDA.py', 
                                    'model_save_path': None, 
                                    'input_h5_fname': 'Nowcast/servir_nowcasting_examples/temp/input_imerg.h5', 
                                    'output_h5_fname':'Nowcast/servir_nowcasting_examples/temp/output_linda.h5', 
                                    'use_gpu': False
                           },
                           'steps': {'model_type': 'steps',
                                    'config_path': 'Nowcast/servir_nowcasting_examples/configs/wa_imerg/PySTEPS.py', 
                                    'model_save_path': None, 
                                    'input_h5_fname': 'Nowcast/servir_nowcasting_examples/temp/input_imerg.h5', 
                                    'output_h5_fname':'Nowcast/servir_nowcasting_examples/temp/output_steps.h5', 
                                    'use_gpu': False
                           },
                           'convlstm': {'model_type': 'convlstm',
                                    'config_path': 'Nowcast/servir_nowcasting_examples/configs/wa_imerg/ConvLSTM.py', 
                                    'model_save_path': 'Nowcast/servir_nowcasting_examples/temp/imerg_only_mse_params.pth', 
                                    'input_h5_fname': 'Nowcast/servir_nowcasting_examples/temp/input_imerg.h5', 
                                    'output_h5_fname':'Nowcast/servir_nowcasting_examples/temp/output_convlstm.h5',
                                    'use_gpu': False
                           },
