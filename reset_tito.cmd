...
REM warmup snapshot (20230602 17:00). Matches:
REM   20230602_1700  20230602_170000  20230602.1700  20230602.170000  202306021700
...
echo   Keep   : states *.tif for 2023-06-02 17:00 ^(any common spelling^)
echo.
...
:is_keep
set "KEEP_HIT=0"
echo %~1| findstr /I /L /C:"20230602_1700" /C:"20230602_170000" /C:"20230602.1700" /C:"20230602.170000" /C:"202306021700" >nul
...
if !TOTAL! GTR 0 if !KEEPN! EQU 0 if not "%FORCE%"=="1" (
  echo ERROR: no state tif matched 2023-06-02 17:00 — refusing to delete any state tifs.
